...
def test_empty_courses_list():
    with sync_playwright() as playwright:
        ...
        email_input.fill('email@email.com')
    ...
    with sync_playwright() as playwright:
        ...
        courses_block = page.get_by_test_id('courses-list-empty-view-title-text')
        expect(courses_block).to_be_visible()
        expect(courses_block).to_have_text('There is no results')

        empty_courses_description = page.get_by_test_id('courses-list-empty-view-description-text')
